	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 iAHP /Users/rspangler/school/computationalneuroscience/neuron/hh_zoo/x86_64/iahp.mod\n");
...
static int  rates ( _p, _ppvar, _thread, _nt, _lv , _lcai ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv , _lcai ;
 {
   double _la , _lb ;
...
static int _ode_count(_type)int _type; { hoc_execerror("iAHP", "cannot be used with CVODE");}
