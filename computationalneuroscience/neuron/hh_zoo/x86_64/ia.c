	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 iA /Users/rspangler/school/computationalneuroscience/neuron/hh_zoo/x86_64/ia.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("iA", "cannot be used with CVODE");}
