...
\quote{Discovering Patterns in Connections}                                 % optional, remove / comment the line if not wanted
...
\item Interested in developing computational frameworks for biological discovery, scientific research and applications for biologically inspired algorithms. 
\end{itemize}

\section{Experience}
%\subsection{Programming}

%% \cventry{2018--present}{Software Engineer}{Stanford Bioengineering - Covert Lab}{Stanford CA}{}{At Stanford I coordinate the efforts of building a whole-cell model. work daily with researchers, students and postdocs to translate biological mechanisms and dynamics into runnable code, expanding on and integrating the effort of all of the lab members into a working whole-cell model. In addition, I conceive, develop and maintain the computational infrastructure and tools required by the various efforts around the lab. \newline{}

%% We translate biological mechanisms and dynamics into runnable code, expanding on and integrating the effort of all of the lab members into a working whole-cell model. In addition, I conceive, develop and maintain the computational infrastructure and tools required by the various efforts around the lab.

%% \item Created a platform for distributed multi-scale modeling of composable whole-cell simulations that exchange resources with a shared molecular environment, with a websockets-based interactive visualization:


\cventry{2018--present}{Software Engineer}{Stanford Bioengineering - Covert Lab}{Stanford CA}{}{I coordinate the efforts of the whole-cell modeling team with graduate students, postdocs and PI's, and in collaboration with other institutions. Beyond the code, I provide computational support, design consultation, implementation strategies and pair programming mentorship. In addition, I lead a consistent and productive practice of code reviews, pull requests, continuous integration, version control and other software engineering best practices.\newline{}
\textbf{Achievements}:
\begin{itemize}
...
%% \item Worked with graduate students and postdocs to provide computational support, design consultation, implementation strategies and pair programming mentorship and feedback.
...
%% \item Lead a consistent and productive practice of code reviews, pull requests, continuous integration, version control and other software engineering best practices.
...
\section{Technology}
\cvitem{Languages}{Clojure, Scala, JavaScript, Python, C/C++, Julia, Java, Bash, SQL}
...
\cvitem{Music}{Piano Tuning, Music Theory, Performance: Exploring the space of all possible musical spaces and relationships.} %\url{https://soundcloud.com/youdonotexist/sessessation}}
